...
'''
from adapters import WindowsTimeDateAdapter, WindowsTimeDeltaAdapter, \
    TimeDateAdapter, NullStringAdapter, TimeDeltaAdapter
from construct import Embed, Const, Tunnel
from construct.adapters import ExprAdapter, HexDumpAdapter
from construct.core import Struct, Pass, Pointer, Peek, LazyBound, Union, Switch, \
    OnDemand
from construct.debug import Debugger
from construct.macros import FlagsEnum, String, Enum, ULInt32, ULInt64, \
    PascalString, If, Field, Array, Padding, ULInt16, CString, IfThenElse, SLInt32, \
    GreedyRange, ULInt8
...
MINIDUMP_MEMORY64_LIST = Struct('MINIDUMP_MEMORY64_LIST',
    ...
    ULInt64('BaseRva'),
    OnDemand(Array(lambda ctx: ctx.NumberOfMemoryRanges, MINIDUMP_MEMORY_DESCRIPTOR64)),
)
...
MINIDUMP_HEADER = Debugger(Struct('MINIDUMP_HEADER',
    ...
    OnDemand(Pointer(lambda ctx: ctx.StreamDirectoryRva,
